...
#  qb_company_address_city                      :string(255)
#  qb_company_address_country_sub_division_code :string(255)
#  qb_company_address_id                        :integer
#  qb_company_address_lat                       :decimal(10, 7)
#  qb_company_address_line_1                    :string(255)
#  qb_company_address_line_2                    :string(255)
#  qb_company_address_line_3                    :string(255)
#  qb_company_address_line_4                    :string(255)
#  qb_company_address_line_5                    :string(255)
#  qb_company_address_lon                       :decimal(10, 7)
#  qb_company_address_postal_code               :string(255)
