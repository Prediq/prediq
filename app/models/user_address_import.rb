# == Schema Information
#
# Table name: prediq_api_development.api_address
#
#  active                      :boolean
...
class UserAddressImport < ActiveRecord::Base

  # If used in a Rails stack:
  self.table_name = "prediq_api_#{Rails.env}.api_address"

  # self.table_name = "prediq_api_development.api_address"

  self.primary_key = 'address_id'

  belongs_to :user_import, primary_key: :customer_id, foreign_key: :customer_id
